...
def getNewPath(path, mode):
    new_path = path[:]
    if mode == 0: new_path.append('U')
    elif mode == 1: new_path.append('D')
    elif mode == 2: new_path.append('L')
    else: new_path.append('R')
